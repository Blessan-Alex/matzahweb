...
export default function Header() {
    ...
    return (
        ...
        >
            {/* Brand Logo - Removed from Hero */}

            {/* Desktop Links & CTA */}
            <div
                ref={linksRef}
                className="flex items-center gap-4 md:gap-10 pointer-events-auto"
            >
                ...
                <div className="flex items-center gap-4">
                    ...
                    <button className="md:hidden transition-opacity duration-200 hover:opacity-60 pointer-events-auto">
